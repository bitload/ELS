...
#define ILI_CS_GPIO_Port GPIOD
#define ILI_RESET_Pin GPIO_PIN_9
#define ILI_RESET_GPIO_Port GPIOD
#define ILI_LED_Pin GPIO_PIN_10
#define ILI_LED_GPIO_Port GPIOD
#define ILI_DC_RS_Pin GPIO_PIN_11
#define ILI_DC_RS_GPIO_Port GPIOD
