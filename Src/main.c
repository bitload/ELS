...
//  __HAL_TIM_SET_COUNTER(&htim2, 4000);
...
//    if (menu_state == 1){
//    	menu_state = display_menu(!HAL_GPIO_ReadPin(GPIOD, ENCODER_BUTTON_Pin));
//    }
//
//    if (menu_state == 0){
//    	if (previous_menu_state != menu_state){
//        	ILI9341_FillScreen(ILI9341_BLACK);
//        	ILI9341_WriteString(0, 10, "Szamlalo: ", Font_16x26, ILI9341_WHITE, ILI9341_BLACK);
//        	previous_menu_state = menu_state;
//    	}
//
//		ILI9341_WriteNumber(0, 50, index, angelcode_28x47_7seg, ILI9341_GREEN, ILI9341_BLACK);
//		HAL_Delay(100);
//
//	    if (index > 500){
//	    	index = 0;
//	    }
//
//	    if (!HAL_GPIO_ReadPin(GPIOD, ENCODER_BUTTON_Pin)){
//	    	menu_state = 1;
//	    }
//	    index++;
//    }
...
//    if (delay_val > 110){
//		delay_val -= 100;
//		__HAL_TIM_SetAutoreload(&htim3, delay_val);
//    }
